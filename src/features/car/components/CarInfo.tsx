  ...
  return (
    <div className="mb-8" role="region" aria-labelledby="car-info-title">
      <div className="mb-6">
        ...
        <div className="flex justify-between gap-2 mb-4">
          <div className="flex flex-col">
            <h1 id="car-info-title" className="text-3xl font-bold">
              {car.brand} {car.model}
            </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
          ...
          <InfoItem
            label="Transmisión"
            value={car.transmission || "Desconocida"}
          />
          <InfoItem label="Color" value={car.color} />
          <InfoItem
            label="Puertas"
            value={car.doors?.toString() || "Desconocido"}
          />
      ...
      <Tabs defaultValue="descripcion">
        ...
        <TabsContent
          value="descripcion"
          className="p-4 bg-muted/30 rounded-md mt-2"
        >
          <p>{car.description}</p>
        </TabsContent>
        <TabsContent
      ...
      <div>
        ...
        <ul className="space-y-1 text-sm">
          ...
          <li>
            <InfoItem
              label="Transmisión"
              value={car.transmission || "Desconocido"}
            />
          </li>
          <li>
            <InfoItem label="Consumo combinado" value="5.2 l/100km" />
          </li>
          <li>
            <InfoItem label="Emisiones CO2" value="118 g/km" />
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul className="space-y-1 text-sm">
          <li>
            <InfoItem label="Longitud" value="4.050 mm" />
          </li>
          <li>
            <InfoItem label="Anchura" value="1.800 mm" />
          </li>
          <li>
            <InfoItem label="Altura" value="1.550 mm" />
          </li>
          <li>
            <InfoItem label="Maletero" value="380 litros" />
          </li>
          <li>
            <InfoItem label="Peso" value="1.165 kg" />
          </li>
        </ul>
      </div>
    </div>
